/**
 * Created by zengyl on 2017/5/11.
 */
import React, {
	Component
} from 'react'
...
class Raio2 extends Component {
	...
	render() {
		imgUrl = this.props.hightlight ? this.props.seledImg || require('.././images/radiocheckboxImgs/selted.png') : this.props.selImg || require('.././images/radiocheckboxImgs/selt.png');
		imgUrlNone = this.props.selnoneImg || require('.././images/radiocheckboxImgs/seltnone.png');
		return (
			<TouchableHighlight
			   underlayColor='transparent'
			   style={[{marginRight:15,width:(width)/3,height:24},this.props.initStyle]}
			   onPress={this.click.bind(this,this.props.value,this.props.child)}>
  				<View  style={{flex:1,flexDirection:'row',alignItems:'center'}} >
  				  ...
  				  <Text style={{color:this.props.disabled?this.props.noneColor||'#dfdfdf':this.props.txtColor||'#666'}}>{this.props.child}</Text>
  				</View>
			</TouchableHighlight>
		)
	}
