...
export default class ApplyDeposit extends Component {
  ...
  componentWillMount() {
    ...
    DeviceEventEmitter.addListener('PayEvent', (event) => {
       Actions.pop()
    });
  }
        ...
        <ScrollView>
          <View style={styles.main}>
            ...
            <View style={styles.mainBottomView}>
              <Text style={[styles.mainText,{fontSize: AppDataConfig.Font_Default_Size + 4,color: AppColorConfig.commonColor}]}>保证金 {this.props.userDepositState.money} 元</Text>
            </View>
            <View style={styles.mainBottomView}>
              <Text style={[styles.mainText,{marginTop: 20}]}>{this.props.userDepositState.texts}</Text>
            </View>
          </View>
        </ScrollView>
